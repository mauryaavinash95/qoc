...
def evolve_schroedinger_discrete_unitary_control_list(evolution_time, hamiltonian,
    ...
    _ = _evaluate_schroedinger_discrete_unitary_control_list(controls, pstate, result)

    return result


def grape_schroedinger_discrete_unitary_control_list(control_count, control_eval_count,
    ...
    pstate = GrapeSchroedingerDiscreteStateUnitaryControlList(complex_controls, control_count,
    ...
    propagator = _evaluate_schroedinger_discrete_unitary_control_list
...
def _evaluate_schroedinger_discrete_unitary_control_list(controls, pstate, reporter):
    """
